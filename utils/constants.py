...
FGBG_HISTORY = config.getint('APP', 'FGBG_HISTORY', fallback=250)
FGBG_VAR_THRESHOLD = config.getint('APP', 'FGBG_VAR_THRESHOLD', fallback=7)
FGBG_DETECT_SHADOWS = config.getboolean('APP', 'FGBG_DETECT_SHADOWS', fallback=False)
