...
FGBG_VAR_THRESHOLD = config.getint('APP', 'FGBG_VAR_THRESHOLD', fallback=16)
...
MOTION_MIN_SINGLE_CONTOUR = config.getint('APP', 'MOTION_MIN_SINGLE_CONTOUR', fallback=3000)
