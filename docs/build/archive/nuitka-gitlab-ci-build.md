...
> Le projet est passé à Cython + image Docker (voir [`../gitlab-ci-build.md`](../gitlab-ci-build.md)).
> Ce document décrit l'ancienne approche Nuitka (exécutable standalone + tar.gz + SCP).
> Conservé pour référence si Nuitka est reconsidéré.
