...
| OT→Internet | Jetson (option, clé 4G) | Coordination Tailscale / DERP | WireGuard / HTTPS | 41641/UDP, 443 | Oui | Accès distant optionnel (`install_xrdp_jetson.sh --tailscale`) | À **retirer** du livrable RUN |
